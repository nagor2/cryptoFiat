...
module.exports = async function(deployer, network, accounts) {
    ...
    if (network == "dashboard") {
        ...
        await deployer.deploy(INTDAO, ['0x82A618305706B14e7bcf2592D4B9324A366b6dAd', cdp.address, auction.address, deposit.address, exchangeRateContract.address, rule.address, stableCoin.address, basket.address],{from: accounts[0]});
        ...
        await deployer.deploy(INTDAO, [weth.address, cdp.address, auction.address, deposit.address, exchangeRateContract.address, rule.address, stableCoin.address, basketContract.address],{from: accounts[0]});
    ...
    * */
        ...
        await deployer.deploy(basketContract, INTDAO.address);
